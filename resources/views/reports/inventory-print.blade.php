...
<head>
    ...
    <style>
        ...
        body { 
            ...
            font-size: 11px; /* Dikurangi dikit agar muat di A5 */
            margin: 0;
            padding: 0;
        ...
        .a4-page {
            width: 287mm; /* 297 - margins */
            height: 200mm; /* 210 - margins */
            margin: 20px auto;
        ...
        .a5-nota {
            ...
            border-right: 1px dashed #ccc; /* Garis potong tengah */
            position: relative;
        }
        .a5-nota:last-child {
            border-right: none;
        ...
        .kop-text { font-weight: bold; font-size: 12px; line-height: 1.2; }
        .kop-text-address { font-size: 8px; font-weight: normal; }
        ...
        .col-nama { width: 45%; }
        .col-banyak { width: 15%; text-align: center; }
        .col-ket { width: 35%; text-align: center; }
        ...
        .header-r { padding-left: 10px; }
    </style>
</head>
<body>
    <div class="no-print">
        <button onclick="window.print()" style="padding: 10px 20px; font-size: 14px; cursor: pointer; font-weight: bold; background: #4CAF50; color: white; border: none; border-radius: 4px;">Print PDF (A4 Landscape)</button>
        <button onclick="window.close()" style="padding: 10px 20px; font-size: 14px; cursor: pointer; margin-left: 10px; border: 1px solid #ccc; background: #fff; border-radius: 4px;">Tutup</button>
        <p style="margin-top: 10px; font-size: 12px; color: #555;">Pastikan memilih ukuran kertas A4 dengan orientasi Landscape pada pengaturan printer.</p>
    </div>

    @php
        // Prepare chunks of 2
        $chunks = collect($grouped)->map(function($transactions, $tanggal) {
            return (object)[
                'tanggal' => $tanggal,
        ...
        <div class="a5-nota">
            ...
            <div class="signatures">
                <div class="sig-row">
                    ...
                    <div class="sig-right">
                        Demak, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ \Carbon\Carbon::parse($nota->tanggal)->format('d/m/Y') }}
                        <br>
                        <span style="border-bottom: 1px dotted #000; width: 120px; display: inline-block; height: 18px;"></span>
                        <br>
                        <div class="signature-line"></div>
                        <div class="nip-text">NIP.</div>
                    </div>
